...
r0=np.load('tmp/r0.npy'); r1=np.load('tmp/r1.npy'); r2=np.load('tmp/r2.npy')
MatHept=np.load('tmp/MatHept.npy'); MatHeptEdge=np.load('tmp/MatHeptEdge.npy'); MatHeptS=np.load('tmp/MatHeptS.npy'); MatHeptL=np.load('tmp/MatHeptL.npy')
...
for itQ in range(begin,stop+1):
    ...
    VecA = np.array(VecA) / np.pi * 180.0
    #-|\/|-#-|\/|-#-|\/|-#-|\/|-#-|\/|-#-|\/|-#-|\/|-#-|\/|-#-|\/|-#-|\/|-#-|\/|-#-|\/|-#-|\/|-#-|\/|-#-|\/|-#-|\/|-#-|\/|-#-|\/|-#
		...
		try:
			...
			ImgCont[int(I1d-MatHeptL.shape[0]/2):int(I1d-MatHeptL.shape[0]/2)+MatHeptL.shape[0],int(I2d-MatHeptL.shape[1]/2):int(I2d-MatHeptL.shape[1]/2)+MatHeptL.shape[1]]=ImgCont[int(I1d-MatHeptL.shape[0]/2):int(I1d-MatHeptL.shape[0]/2)+MatHeptL.shape[0],int(I2d-MatHeptL.shape[1]/2):int(I2d-MatHeptL.shape[1]/2)+MatHeptL.shape[1]]+MatHeptLRot1[0:temp.shape[0], 0:temp.shape[1]]
                ...
                if np.amax(ImgCont)>1:
                    ...
                    ImgTmp=np.zeros(ImgPl2.shape); ImgTmp[int(I1c-MatHept.shape[0]/2):int(I1c-MatHept.shape[0]/2)+MatHept.shape[0],int(I2c-MatHept.shape[1]/2):int(I2c-MatHept.shape[1]/2)+MatHept.shape[1]]=ImgTmp[int(I1c-MatHept.shape[0]/2):int(I1c-MatHept.shape[0]/2)+MatHept.shape[0],int(I2c-MatHept.shape[1]/2):int(I2c-MatHept.shape[1]/2)+MatHept.shape[1]]+MatHeptRot0
                    Val00=np.sum(ImgCont1*ImgTmp*ImgPl2)
                    ImgTmp=np.zeros(ImgPl2.shape); ImgTmp[int(I1c-MatHept.shape[0]/2):int(I1c-MatHept.shape[0]/2)+MatHept.shape[0],int(I2c-MatHept.shape[1]/2):int(I2c-MatHept.shape[1]/2)+MatHept.shape[1]]=ImgTmp[int(I1c-MatHept.shape[0]/2):int(I1c-MatHept.shape[0]/2)+MatHept.shape[0],int(I2c-MatHept.shape[1]/2):int(I2c-MatHept.shape[1]/2)+MatHept.shape[1]]+MatHeptRot1
    ...
    if len(VecCont) > 3:
		...
		I1=VecCont[itCt,2]; I2=VecCont[itCt,3]; 
